...
public class RampPower {
    ...
    public RampPower(double dOrigMinPower, double dOrigMaxPower, double dOrigRampUpPct, double dOrigRampDownPct, double dOrigDownProportion) {
        ...
        this.dRampDownDistancePct 	= 1.0-dRampDownPct;
    }
